...
namespace VTuber.Reincarnation
{
    ...
    {
        [Space(3)]
        [HorizontalGroup("VCardRarityRequirement")]
        [LabelText("稀有度")] public VCardRarity rarity;
        [HorizontalGroup("VCardRarityRequirement")]
    ...
    {
        [Space(3)]
        [LabelText("继承位数量")] public int cardCount;
        [LabelText("容量")] public int cardTotalCapacity;
        [LabelText("稀有度要求")]public List<VCardRarityRequirement> cardRarityRequirements = new List<VCardRarityRequirement>();
    }
    ...
    {
        [Space(3)]
        [HorizontalGroup("cardCapacity")]
        [LabelText("稀有度")] public VCardRarity rarity;
        [HorizontalGroup("cardCapacity")]
        [LabelText("容量")] public int capacity;
        [HorizontalGroup("cardCapacity")]
        [LabelText("升级容量")]public int upgradeCapacity;
    }
    ...
    public class VAttributeLevelInfo
    {
        [Space(3)]
        [HorizontalGroup("VRelicRewardInfo")]
        [LabelText("等级参数")] public string levelParam;
    }
    ...
    {
        [Space(3)]
        [LabelText("能力ID（歌力..）")] public int ability;
    ...
    {
        [Space(3)]
        [LabelText("效果ID")] public uint effect;
    ...
    public class VEffectLevelInfo
    {
        ...
        [LabelText("容量")] public int capacity;
        [Header("直播属性")]
        [LabelText("直播属性要求")] public List<VEffectLevelRequirement> streamEffectsRequirements;
        [Header("其他属性")]
        [LabelText("其他属性要求")] public List<VEffectLevelRequirement> attributeEffectsRequirements;
    }

    public class VReincarnationConfiguration : VScriptableObject
    {
        [Header("卡牌")]
        [LabelText("评分等级信息")] public Dictionary<string, VCardLevelInfo> cardLevels;
        [LabelText("卡牌容量")]public List<VCardCapacityInfo> cardCapacities;
        
        [Header("遗物")]
        [LabelText("遗物容量")] public Dictionary<string, int> relicCount;
        [LabelText("阶段性事件对应遗物")] public List<VRelicRewardInfo> relicRewards;

        [Header("属性")] 
        [LabelText("属性效果等级容量")]public Dictionary<int, int> effectCapacities;

        [LabelText("直播属性词条")] public List<VAbilityEffectInfo> streamAttributeEffects;
        [Space(3)]
        [LabelText("其他属性词条")] public List<VAttributeEffectInfo> attributeEffects;
