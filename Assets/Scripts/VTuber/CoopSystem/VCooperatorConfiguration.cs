...
namespace VTuber.CoopSystem
{
    ...
    {
        [Header("协助者")] [SerializeField] private uint id;

        [FormerlySerializedAs("name")] [SerializeField] [LabelText("协助者名称")]
        ...
        [Header("帮助事件")] [HorizontalGroup("MinMaxEvents")] [SerializeField] [LabelText("最少帮助事件")]
        private int minEvents;

        [Header("")] [HorizontalGroup("MinMaxEvents")] [SerializeField] [LabelText("最多帮助事件")]
