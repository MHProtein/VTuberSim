...
namespace VTuber.BattleSystem.BattleAttribute
{
    ...
    {
        private readonly int _defaultPlayCountPerTurn;
        ...
        public override void OnEnable()
        {
            ...
            VBattleRootEventCenter.Instance.RegisterListener(VBattleEventKey.OnTurnBegin,
                dict => SetValue(_defaultPlayCountPerTurn, false));
        }

        public override void OnDisable()
        {
            base.OnDisable();
            VBattleRootEventCenter.Instance.RemoveListener(VBattleEventKey.OnTurnBegin,
                dict => SetValue(_defaultPlayCountPerTurn, false));
        }
    }
}