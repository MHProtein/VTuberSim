...
namespace VTuber.BattleSystem.Effect
{
    ...
    {
        private readonly VUpgradableValue<int> _cardCount;
        private readonly VCardPileType _cardPileType;

        public VPickCardFromPileEffect(VPickCardFromPileEffectConfiguration configuration, string parameter,
            ...
            bool shouldApplyTwice = false)
        {
            ...
            VBattleRootEventCenter.Instance.Raise(VBattleEventKey.OnRequestPickCardsFromPile,
