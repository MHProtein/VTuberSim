...
namespace VTuber.BattleSystem.Effect
{
    public class VAddPercentageFromAttributeEffect : VEffect, IVValuePreview
    {
        ...
        public VAddPercentageFromAttributeEffect(VAddPercentageFromAttributeEffectConfiguration configuration,
            ...
            bool shouldApplyTwice = false)
        {
            ...
            var delta = VMathUtils.FloatToInt(_percentage.Value * attributeToAdd.Value);
            ...
            VDebug.Log(
                $"Effect {_configuration.effectName} added {delta} to {attributeNameToBeAdded}. New value: {attributeToBeAdded.Value}");
        }
