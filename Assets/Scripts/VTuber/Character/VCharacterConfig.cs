...
namespace VTuber.Character
{
    public class VCharacterConfiguration : VScriptableObject
    {
        ...
        [FormerlySerializedAs("fillingEventIDSize2")] [SerializeField] [LabelText("补充事件(大小2)")]
        public uint fillingEventIDDuration2;

        [FormerlySerializedAs("fillingEventIDSize3")] [SerializeField] [LabelText("补充事件(大小3)")]
        public uint fillingEventIDDuration3;

        #region AttributeConfigs

        [HorizontalGroup("StaminaGroup", Gap = 10)] [Header("体力")] [LabelText("初始值")]
        public int staminaInitialValue;

        [HorizontalGroup("StaminaGroup")] [Header("")] [LabelText("最小值")]
        public int staminaMinValue;

        [HorizontalGroup("StaminaGroup")] [Header("")] [LabelText("最大值")]
        public int staminaMaxValue;

        [PropertySpace(10)] [LabelText("Config文件")]
        public VCharacterAttributeConfiguration staminaConfiguration;

        // Pressure
        [HorizontalGroup("PressureGroup", Gap = 10)] [Header("压力")] [LabelText("初始值")]
        public int pressureInitialValue;

        [HorizontalGroup("PressureGroup")] [Header("")] [LabelText("最小值")]
        public int pressureMinValue;

        [HorizontalGroup("PressureGroup")] [Header("")] [LabelText("最大值")]
        public int pressureMaxValue;

        [LabelText("压力效果表")] public List<VEffectItem> pressureEffects = new();

        [PropertySpace(10)] [LabelText("Config文件")]
        public VCharacterAttributeConfiguration pressureConfiguration;

        // Singing Ability
        [HorizontalGroup("SingingGroup", Gap = 10)] [Header("歌力")] [LabelText("初始值")]
        public int singingAbilityInitialValue;

        [HorizontalGroup("SingingGroup")] [Header("")] [LabelText("最小值")]
        public int singingAbilityMinValue;

        [HorizontalGroup("SingingGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Gaming Ability
        [HorizontalGroup("GamingGroup", Gap = 10)] [Header("游戏力")] [LabelText("初始值")]
        public int gamingAbilityInitialValue;

        [HorizontalGroup("GamingGroup")] [Header("")] [LabelText("最小值")]
        public int gamingAbilityMinValue;

        [HorizontalGroup("GamingGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Chatting Ability
        [HorizontalGroup("ChattingGroup", Gap = 10)] [Header("杂谈力")] [LabelText("初始值")]
        public int chattingAbilityInitialValue;

        [HorizontalGroup("ChattingGroup")] [Header("")] [LabelText("最小值")]
        public int chattingAbilityMinValue;

        [HorizontalGroup("ChattingGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("SingingRatioGroup", Gap = 10)] [Header("歌力转化率%")] [LabelText("初始值")]
        public float singingAbilityConversionRatioInitialValue;

        [HorizontalGroup("SingingRatioGroup")] [Header("")] [LabelText("最小值")]
        public int singingAbilityConversionRatioMinValue;

        [HorizontalGroup("SingingRatioGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("GamingRatioGroup", Gap = 10)] [Header("游戏力转化率%")] [LabelText("初始值")]
        public float gamingAbilityConversionRatioInitialValue;

        [HorizontalGroup("GamingRatioGroup")] [Header("")] [LabelText("最小值")]
        public int gamingAbilityConversionRatioMinValue;

        [HorizontalGroup("GamingRatioGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("ChattingRatioGroup", Gap = 10)] [Header("杂谈力转化率%")] [LabelText("初始值")]
        public float chattingAbilityConversionRatioInitialValue;

        [HorizontalGroup("ChattingRatioGroup")] [Header("")] [LabelText("最小值")]
        public int chattingAbilityConversionRatioMinValue;

        [HorizontalGroup("ChattingRatioGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("SingingEfficiencyGroup", Gap = 10)] [Header("歌力获得效率%")] [LabelText("初始值")]
        public int singingAbilityGainEfficiencyInitialValue;

        [HorizontalGroup("SingingEfficiencyGroup")] [Header("")] [LabelText("最小值")]
        public int singingAbilityGainEfficiencyMinValue;

        [HorizontalGroup("SingingEfficiencyGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("GamingEfficiencyGroup", Gap = 10)] [Header("游戏力获得效率%")] [LabelText("初始值")]
        public int gamingAbilityGainEfficiencyInitialValue;

        [HorizontalGroup("GamingEfficiencyGroup")] [Header("")] [LabelText("最小值")]
        public int gamingAbilityGainEfficiencyMinValue;

        [HorizontalGroup("GamingEfficiencyGroup")] [Header("")] [LabelText("最大值")]
        ...
        [HorizontalGroup("ChattingEfficiencyGroup", Gap = 10)] [Header("杂谈力获得效率%")] [LabelText("初始值")]
        public int chattingAbilityGainEfficiencyInitialValue;

        [HorizontalGroup("ChattingEfficiencyGroup")] [Header("")] [LabelText("最小值")]
        public int chattingAbilityGainEfficiencyMinValue;

        [HorizontalGroup("ChattingEfficiencyGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Follower Count
        [HorizontalGroup("FollowerGroup", Gap = 10)] [Header("粉丝数")] [LabelText("初始值")]
        public int followerCountInitialValue;

        [HorizontalGroup("FollowerGroup")] [Header("")] [LabelText("最小值")]
        public int followerCountMinValue;

        [HorizontalGroup("FollowerGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Membership Count
        [HorizontalGroup("MembershipGroup", Gap = 10)] [Header("舰长数")] [LabelText("初始值")]
        public int membershipCountInitialValue;

        [HorizontalGroup("MembershipGroup")] [Header("")] [LabelText("最小值")]
        public int membershipCountMinValue;

        [HorizontalGroup("MembershipGroup")] [Header("")] [LabelText("最大值")]
        public int membershipCountMaxValue;

        [LabelText("舰长Buff表")] public List<VRangeValueMap<uint>> membershipBuffs = new();

        [PropertySpace(10)] [LabelText("Config文件")]
        public VCharacterAttributeConfiguration membershipCountConfiguration;

        // Follower-to-Viewer Ratio
        [HorizontalGroup("FollowerRatioGroup", Gap = 10)] [Header("粉丝同接转化率%")] [LabelText("初始值")]
        public int followerToViewerRatioInitialValue;

        [HorizontalGroup("FollowerRatioGroup")] [Header("")] [LabelText("最小值")]
        public int followerToViewerRatioMinValue;

        [HorizontalGroup("FollowerRatioGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Money
        [HorizontalGroup("MoneyGroup", Gap = 10)] [Header("金钱")] [LabelText("初始值")]
        public int moneyInitialValue;

        [HorizontalGroup("MoneyGroup")] [Header("")] [LabelText("最小值")]
        public int moneyMinValue;

        [HorizontalGroup("MoneyGroup")] [Header("")] [LabelText("最大值")]
        ...
        // Money
        [HorizontalGroup("RevenueShareRateGroup", Gap = 10)] [Header("直播分成率%")] [LabelText("初始值")]
        public int revenueShareRateInitialValue;

        [HorizontalGroup("RevenueShareRateGroup")] [Header("")] [LabelText("最小值")]
        public int revenueShareRateMinValue;

        [HorizontalGroup("RevenueShareRateGroup")] [Header("")] [LabelText("最大值")]
        public int revenueShareRateMaxValue;

        [PropertySpace(10)] [LabelText("Config文件")]
        public VCharacterAttributeConfiguration revenueShareRateConfiguration;

        [HorizontalGroup("SkipEventStaminaRecovery", Gap = 10)] [Header("跳过事件回复体力")] [LabelText("初始值")]
        public int skipEventStaminaRecoveryInitialValue;

        [HorizontalGroup("SkipEventStaminaRecovery")] [Header("")] [LabelText("最小值")]
        public int skipEventStaminaRecoveryMinValue;

        [HorizontalGroup("SkipEventStaminaRecovery")] [Header("")] [LabelText("最大值")]
        public int skipEventStaminaRecoveryMaxValue;

        [LabelText("Config文件")] public VCharacterAttributeConfiguration skipEventStaminaRecoveryConfiguration;

        [HorizontalGroup("SkipTurnStaminaRecovery", Gap = 10)] [Header("跳过回合回复体力")] [LabelText("初始值")]
        public int skipTurnStaminaRecoveryInitialValue;

        [HorizontalGroup("SkipTurnStaminaRecovery")] [Header("")] [LabelText("最小值")]
        public int skipTurnStaminaRecoveryMinValue;

        [HorizontalGroup("SkipTurnStaminaRecovery")] [Header("")] [LabelText("最大值")]
        public int skipTurnStaminaRecoveryMaxValue;

        [LabelText("Config文件")] public VCharacterAttributeConfiguration skipTurnStaminaRecoveryConfiguration;
